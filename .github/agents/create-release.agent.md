---
name: create-release
description: Prepare and publish a new release version for fips-agents-cli
argument-hint: "version number (e.g., 0.1.2)"
tools:
  - vscode-files
  - vscode-terminal
target: vscode
...
Use #tool:vscode-files to read and edit README.md
Use #tool:vscode-terminal to execute the release script
